...
const CategoriesCard = ({title, img }) => {
  return (
    <div className="h-[150px] lg:h-[170px] relative bg-[#1c1c1c] rounded-2xl overflow-hidden shadow-lg hover:scale-[1.02] transition-all duration-300 border-2 border-neutral-800">
      {/* Image - centered */}
